...
# Order Status Position Order
CREATED_POSITION_ORDER = 0
ACCEPTED_POSITION_ORDER = 1
REJECTED_POSITION_ORDER = 2
FINISHED_POSITION_ORDER = 3
AWAITING_POSITION_ORDER = 4
DELIVERING_POSITION_ORDER = 5
RECEIVED_POSITION_ORDER = 6
...
AWS_S3_ACCESS_KEY_ID = env_handler.AWS_S3_ACCESS_KEY_ID

AWS_S3_SECRET_ACCESS_KEY = env_handler.AWS_S3_SECRET_ACCESS_KEY
